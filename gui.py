...
class GUI(Tk):
    def __init__(self):
        ...
        growLightButton = Button(self, text="Grow Light: OFF", command=self.toggleGrowLights) 
        growLightButton.grid(row=2, column=0, sticky='nsew')
        whiteLightButton = Button(self, text="Camera Light: OFF", command=self.toggleCameraLights)
